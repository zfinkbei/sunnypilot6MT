...
class CarController(CarControllerBase):
  def __init__(self, dbc_name, CP, VM):
    ...
    self._auto_lock_by_speed = False #self.param_s.get_bool("ToyotaAutoLockBySpeed")
    self._auto_unlock_by_shifter = False #self.param_s.get_bool("ToyotaAutoUnlockByShifter")
